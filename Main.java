...
public class Main {
	...
	public static void main(String[] args) {
		...
		faqs1.question= "Bu kamp ücretsiz mi?";
		 ...
		 FAQS faqs2= new FAQS();
		 faqs2.question= "Bu kamp nerede yayýmlanacak?";
		 FAQS ans2= new FAQS();
		 ans2.answer="Canlý yayýn youtube kanalýnda yayýmlanacak.";
		  FAQS faqs3= new FAQS();
		  faqs3.question= "Yayýn tarih ve saati ile ilgili bilgiler nelerdir?";
		 FAQS ans3= new FAQS();
		 ans3.answer="Her çarþamba ve cumartesi günleri 9.30 pm'de";
